...
// Lazy initialization to avoid circular dependency issues with MIME_TYPES
let IMAGE_PLACEHOLDER_IMG: HTMLImageElement | null = null;
...
let IMAGE_ERROR_PLACEHOLDER_IMG: HTMLImageElement | null = null;
const getImageErrorPlaceholderImg = () => {
  if (!IMAGE_ERROR_PLACEHOLDER_IMG) {
...
const drawImagePlaceholder = (
  ...
  context.drawImage(
    element.status === "error"
      ? getImageErrorPlaceholderImg()
      : getImagePlaceholderImg(),
